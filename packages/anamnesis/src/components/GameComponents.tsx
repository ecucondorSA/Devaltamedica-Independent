...
// Animación de transición entre preguntas/secciones
...
export const AnimacionTransicion: React.FC<AnimacionTransicionProps> = ({ tipo, onComplete }) => {
  ...
  const mensajes = { pregunta: ['¡Excelente!', '¡Sigue así!', '¡Genial!'], seccion: ['¡Sección completada!', '¡Nuevo territorio desbloqueado!'], completado: ['¡Misión cumplida!', '¡Eres un héroe de la salud!'] }
...
// Mascota médica (asistente emocional)
...
export const MascotaMedica: React.FC<MascotaMedicaProps> = ({ estado, mensaje }) => {
  const expresiones = { neutral: '😊', feliz: '😄', pensando: '🤔', celebrando: '🎉' }
  return (
