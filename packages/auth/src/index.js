...
export { AuthContext, AuthProvider, useAuth, useProtectedRoute, useRequireAuth, useRole, } from './hooks/useAuth';
// ============== LEGACY EXPORTS ==============
...
export { AuthGuard, ProtectedRoute, PublicRoute, RouteGuard, } from './components';
