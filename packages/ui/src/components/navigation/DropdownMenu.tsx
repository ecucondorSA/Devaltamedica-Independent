/**
 * 📋 DROPDOWN MENU - ALTAMEDICA UI
 * Menús desplegables estandarizados basados en Radix UI
 * Usado por: Admin, Doctors, Patients, Companies Apps
 */
...
>(({ className, inset, variant = 'default', ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      inset && "pl-8",
      variant === 'medical' && "text-blue-600 focus:bg-blue-50",
