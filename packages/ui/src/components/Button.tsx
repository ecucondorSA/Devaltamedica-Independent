  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95',
  {
    variants: {
      variant: {
        ...
        default:
          'bg-primary-500 text-white hover:bg-primary-600 focus-visible:ring-primary-500 shadow-altamedica hover:shadow-altamedica-lg',
        ...
        outline:
          'border-2 border-primary-500 bg-white text-primary-700 hover:bg-primary-50 hover:text-primary-800 focus-visible:ring-primary-500',

        // Secundario - Fondo suave con texto oscuro para mejor contraste
        secondary:
          'bg-primary-50 text-primary-800 hover:bg-primary-100 hover:text-primary-900 focus-visible:ring-primary-500',
        ...
        emergency:
          'bg-alert-600 text-white hover:bg-alert-700 focus-visible:ring-alert-500 animate-pulse',

        // Argentina - Azul argentino sólido
        argentina:
          'bg-argentina-500 text-white hover:bg-argentina-600 focus-visible:ring-argentina-500',
      },
      size: {
