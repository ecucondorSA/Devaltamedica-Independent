...
exports.updateFCMToken = exports.scheduleAppointmentReminders = exports.sendBatchNotifications = exports.sendMedicalNotification = void 0;
...
exports.sendMedicalNotification = (0, https_1.onRequest)({ cors: true }, async (request, response) => {
    try {
        const { recipientId, type, title, body, priority, data, medicalMetadata } = request.body;
...
exports.sendBatchNotifications = (0, https_1.onRequest)({ cors: true }, async (request, response) => {
    try {
...
exports.scheduleAppointmentReminders = (0, https_1.onRequest)({ cors: true }, async (request, response) => {
    try {
        const db = (0, firestore_1.getFirestore)();
        const now = new Date();
...
exports.updateFCMToken = (0, https_1.onRequest)({ cors: true }, async (request, response) => {
    try {
