...
export default function HospitalNetworkDashboard({ hospitalId, config }: DashboardProps) {
  ...
  const loadNetworkData = useCallback(async () => {
    ...
    const mockHospitals = [
      ...
      },
      {
        ...
        location: {
          ...
          city: 'San Miguel',
          country: 'Argentina',
          coordinates: [-34.542, -58.712] as [number, number],
        },
      },
      {
        id: 'hosp-3',
    ...
    const mapFormattedHospitals: MapHospital[] = mockHospitals.map((hospital) => ({
      ...
      status:
        hospital.capacity.percentage > 95
          ? 'saturated'
          : hospital.capacity.percentage > 85
            ? 'critical'
            : hospital.capacity.percentage > 75
              ? 'warning'
              : 'normal',
  ...
  const checkCompletedRedistributions = useCallback(() => {
    ...
    setRedistributionSuggestions((prev) =>
      prev.filter((s) => s.status !== 'completed' || s.createdAt > fiveMinutesAgo),
    );
  }, []);
  ...
  const generateRedistributionSuggestions = (hospitals: any[]): RedistributionSuggestion[] => {
    ...
    const hasCapacity = hospitals
      .filter((h) => h.capacity.percentage < 80)
    ...
    oversaturated.forEach((fromHosp) => {
      ...
      if (patientsToTransfer > 0 && hasCapacity.length > 0) {
        ...
        suggestions.push({
          ...
          priority:
            fromHosp.capacity.percentage > 95
              ? 'critical'
              : fromHosp.capacity.percentage > 90
                ? 'high'
                : 'medium',
  ...
  const convertRedistributionSuggestionsForMap = (): MapRoute[] => {
    return redistributionSuggestions
      .map<MapRoute | null>((suggestion) => {
        ...
        return {
          ...
          progress:
            suggestion.status === 'executing' ? Math.floor(Math.random() * 80) + 10 : undefined,
        } as MapRoute;
      })
  ...
  // toggleSection se importa desde useHospitalDashboard
  ...
  const hospitalCardStyle: CSSProperties = {
    ...
    boxShadow: isDarkMode
      ? `0 4px 20px ${solarizedColors.base03}40`
      : `0 4px 20px ${solarizedColors.base01}20`,
  };
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              <div>
                <h1
                  className={`text-3xl font-bold tracking-wide leading-tight transition-all duration-300 ${
                    isDarkMode
                ...
                <p
                  className={`mt-2 text-sm transition-colors duration-300 font-medium tracking-wide ${
                    isDarkMode
                ...
                >
                  <span
                    className={`${isDarkMode ? `text-[${solarizedColors.green}]` : `text-[${solarizedColors.blue}]`}`}
                  >
                    Red AltaMedica
                  </span>
                  {' • '}
                  <span
                    className={`${isDarkMode ? `text-[${solarizedColors.yellow}]` : `text-[${solarizedColors.orange}]`} font-bold`}
                  >
                    {networkStatus.total}
                  </span>
              ...
              {emergencyMode && (
                <div className="animate-pulse">
                  <Badge
                    className={`px-4 py-2 text-sm font-bold tracking-wide border-2 transition-all duration-300`}
                    style={{
                      backgroundColor: isDarkMode
                        ? `${solarizedColors.red}30`
                        : `${solarizedColors.red}20`,
                      color: solarizedColors.red,
          ...
          <div
            className={`grid grid-cols-1 md:grid-cols-4 gap-4 ${isCompactView ? 'gap-2' : 'gap-4'}`}
          >
            <Card
              className={`group hover:scale-105 transform transition-all duration-500 overflow-hidden shadow-lg hover:shadow-xl ${
                isDarkMode
              ...
              style={{
                boxShadow: isDarkMode
                  ? `0 4px 20px ${solarizedColors.green}20`
                  : `0 4px 20px ${solarizedColors.green}15`,
              }}
            >
              <CardContent className={`p-4 relative ${isCompactView ? 'p-3' : 'p-4'}`}>
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`h-12 w-12 rounded-full flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:rotate-12`}
                    style={{
                      backgroundColor: isDarkMode
                        ? `${solarizedColors.green}20`
                        : `${solarizedColors.green}15`,
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-r from-transparent transition-opacity duration-500 opacity-0 group-hover:opacity-100`}
                  style={{
            ...
            <Card
              ...
              style={{
                boxShadow: isDarkMode
                  ? `0 4px 20px ${solarizedColors.yellow}20`
                  : `0 4px 20px ${solarizedColors.yellow}15`,
              }}
            >
              <CardContent className={`p-4 relative ${isCompactView ? 'p-3' : 'p-4'}`}>
                <div className="flex items-center justify-between">
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: isDarkMode
                        ? `${solarizedColors.yellow}20`
                        : `${solarizedColors.yellow}15`,
            ...
            <Card
              ...
              style={{
                boxShadow: isDarkMode
                  ? `0 4px 20px ${solarizedColors.red}20`
                  : `0 4px 20px ${solarizedColors.red}15`,
              }}
            >
              <CardContent className={`p-4 relative ${isCompactView ? 'p-3' : 'p-4'}`}>
                <div className="flex items-center justify-between">
            ...
            <Card
              ...
              style={{
                boxShadow: isDarkMode
                  ? `0 4px 20px ${solarizedColors.blue}20`
                  : `0 4px 20px ${solarizedColors.blue}15`,
              }}
            >
              <CardContent className={`p-4 relative ${isCompactView ? 'p-3' : 'p-4'}`}>
                <div className="flex items-center justify-between">
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: isDarkMode
                        ? `${solarizedColors.blue}20`
                        : `${solarizedColors.blue}15`,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div style={hospitalCardStyle}>
                <div
                  style={{
                    padding: '1.5rem',
                    borderBottom: `1px solid ${isDarkMode ? solarizedColors.base01 : solarizedColors.base1}`,
                  }}
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div
                      style={{
                        ...(metrics.occupancy.beds.percentage >= 90
                          ? criticalBadgeStyle
                          : metrics.occupancy.beds.percentage >= 75
                            ? warningBadgeStyle
                            : successBadgeStyle),
                      }}
                    >
                ...
                <div style={{ padding: '1.5rem' }}>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      >
                        {metrics.occupancy.beds.occupied}
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      >
                        {metrics.occupancy.beds.available}
                      </span>
                    </div>
                    <div
                      style={{
                ...
                <div style={{ padding: '1.5rem' }}>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      >
                        {metrics.occupancy.emergency.waiting}
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        style={{
                          ...
                          fontFamily: '"JetBrains Mono", monospace',
                          animation:
                            metrics.occupancy.emergency.critical > 0 ? 'pulse 2s infinite' : 'none',
                        }}
                      >
                        {metrics.occupancy.emergency.critical}
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      {emergencyMode ? (
                        ...
                        <>
                          ...
                          >
                            🎛️ Sistema de Control Inteligente
                          </span>
                        </>
                      )}
                    </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                          <div>
                            ...
                            <span className="ml-1 font-bold">
                              {Math.round(
                                (selectedHospitalOnMap.currentCapacity /
                                  selectedHospitalOnMap.maxCapacity) *
                                  100,
                              )}
                              %
                            </span>
                          ...
                          <div>
                            ...
                            <span className="ml-1 font-bold">
                              {selectedHospitalOnMap.waitingPatients}
                            </span>
                          </div>
                          <div>
                            <span className="text-blue-700">Emergencias:</span>
                            <span className="ml-1 font-bold text-red-600">
                              {selectedHospitalOnMap.emergencyPatients}
                            </span>
                          </div>
                          <div>
                            ...
                            <span
                              className={`ml-1 font-bold ${
                                selectedHospitalOnMap.status === 'saturated'
                                  ? 'text-red-600'
                                  : selectedHospitalOnMap.status === 'critical'
                                    ? 'text-orange-600'
                                    : selectedHospitalOnMap.status === 'warning'
                                      ? 'text-yellow-600'
                                      : 'text-green-600'
                              }`}
                            >
                ...
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    ...
                    <Badge variant="outline" className="ml-2">
                      {redistributionSuggestions.filter((s) => s.status === 'pending').length}{' '}
                      pendientes
                    </Badge>
                  </CardTitle>
                </CardHeader>
                                ...
                                <div className="space-y-1">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-xs">
                                      Tiempo estimado: {suggestion.estimatedTime} min
                                    </span>
                                  </div>
                        ...
                        <div className="flex items-start justify-between">
                                ...
                                <div className="space-y-1">
                                  ...
                                  <div className="flex justify-between border-t pt-1">
                                    ...
                                    <span className="font-bold text-red-700">
                                      {shortage.shortage} profesionales
                                    </span>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div>
                                ...
                                <div className="space-y-2">
                                  ...
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-xs">
                                      Aumento tiempo espera:{' '}
                                      <span className="font-bold text-red-600">
                                        {shortage.estimatedWaitIncrease}%
                                      </span>
                                    </span>
                                  </div>
                                  <div className="text-xs text-gray-500">
                          ...
                          <div className="ml-4 space-y-2 min-w-[120px]">
                            {!shortage.autoJobPostingTriggered && (
                              <Button
                                onClick={() =>
                                  triggerAutomaticJobPosting(shortage.hospitalId, {
                                    name: shortage.specialty,
                                    saturation: 95,
                                  })
                                }
                                size="sm"
                      ...
                      <div key={posting.id} className="border rounded-lg p-4 bg-green-50">
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <Badge
                            className={cn(
                              'text-xs',
                              posting.urgencyLevel === 'critical'
                                ? 'bg-red-100 text-red-800'
                                : posting.urgencyLevel === 'urgent'
                                  ? 'bg-orange-100 text-orange-800'
                                  : 'bg-yellow-100 text-yellow-800',
                            )}
                          >
