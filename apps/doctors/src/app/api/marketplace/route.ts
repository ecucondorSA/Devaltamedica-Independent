...
const fallbackMarketplaceOffers = [
  ...
  },
  {
    ...
    urgent: false,
    description:
      'Oportunidad para un pediatra en nuestra clínica especializada en atención infantil. Ambiente familiar y equipo de apoyo completo.',
    requirements: [
  ...
  },
  {
    ...
    urgent: true,
    description:
      'Dermatólogo para consultas de telemedicina. Plataforma tecnológica avanzada y horario flexible.',
    requirements: [
  ...
  },
  {
    ...
    urgent: false,
    description:
      'Ginecólogo para nuestro centro médico privado. Equipamiento de última generación y equipo de apoyo completo.',
    requirements: [
  ...
  },
  {
    ...
    urgent: false,
    description:
      'Psiquiatra para nuestro centro especializado en salud mental. Enfoque en terapia cognitivo-conductual y medicación.',
    requirements: [
      'Especialidad en Psiquiatría',
      '4+ años de experiencia',
      'Certificación en terapias específicas',
...
export const GET = requireRole(['DOCTOR' as any], async (request: NextRequest, user: any) => {
  try {
    ...
    try {
      ...
      if (specialty) {
        filteredOffers = filteredOffers.filter(
          (offer) => offer.specialty.toLowerCase() === specialty.toLowerCase(),
        );
      }
