...
export const APPS: Record<string, AppInfo> = {
  ...
  "web-app": {
    ...
    routes: [
      ...
      {
        // path: "/anamnesis-interactiva", // removido en marketing scope
      ...
      {
        // path: "/anamnesis-juego", // removido en marketing scope
      ...
      {
        // Deprecated: /home-optimized eliminado tras fusión de páginas
      },
      {
        path: "/hospital3d",
        title: "Hospital3D",
